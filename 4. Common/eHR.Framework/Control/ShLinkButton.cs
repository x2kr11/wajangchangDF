...
namespace eHR.Framework.Control
{
    ...
    [ToolboxData("<{0}:ShLinkButton runat=server CssClass='btn_b'>button</{0}:ShLinkButton>")]
    public class ShLinkButton : System.Web.UI.WebControls.LinkButton
    {
        /// <summary>
        /// 기본 버튼 스타일
        /// </summary>
