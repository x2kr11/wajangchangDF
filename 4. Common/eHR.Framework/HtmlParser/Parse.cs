...
namespace eHR.Framework.HtmlParser
{
    ...
    public class Parse : AttributeList
    {
        ...
        public void ParseAttributeValue()
        {
            ...
            if (GetCurrentChar() == '=')
            {
                ...
                if ((GetCurrentChar() == '\'') || (GetCurrentChar() == '\"'))
                {
                    ...
                    {
                        if (m_ParseValueIndex == -1)
                        {
                            m_ParseValueIndex = m_idx;
                        }
        ...
        public void AddAttribute()
        {
            ...
            Attribute a = new Attribute(m_parseName, m_parseValue, m_parseDelim, m_ParseValueIndex);
            Add(a);
        }
        ...
        private int m_ParseValueIndex = -1;
        /// <summary>
        /// 속성값이 시작하는 Html문자열 Index 입니다.
        /// </summary>
        public int ParseValueIndex
        {
            get
            {
                return m_ParseValueIndex;
            }

            set
            {
                m_ParseValueIndex = value;
            }
        }
