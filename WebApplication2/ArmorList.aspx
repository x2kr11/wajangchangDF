<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArmorList.aspx.cs" Inherits="WebApplication2.ArmorList" %>
                        ...
                        <div class="section_margin_s">
                                ...
                                <table class="tbl_hori_inside" summary="insert">
                                    ...
                                    <tbody>
                                        <tr class="hori_t_row">
                                            ...
                                            <th scope="row" class="hori_t_head">세트 방어구</th>
                                            <td class="hori_t_data">
                                                <select class="jqForm pct" id="ddlArmor" runat="server" onchange="ddlLocation_change()">
                                                    <option value="ALL">All</option>
                                                    <option value="블랙 포멀">마계의 정중한 신사</option>
                                                    <option value="오기일">오기일의 꽃</option>
                                                    <option value="눈부신">찬란한 명예의 상징</option>
                                                    <option value="천년">고대전쟁의 여신</option>
                                                    <option value="메탈라인">센츄리온 히어로</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <p style="margin: 15px 0;">
                                <div class="board_list">
                                    <asp:GridView ID="gvArmorList" runat="server" AutoGenerateColumns="false" CssClass="board_list_table" EmptyDataText='empty' ShowHeaderWhenEmpty="true" CellPadding="0" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvArmorList_PageIndexChanging" PageIndex="0">
